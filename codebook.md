...
The source files used to create the tidy data set from the extracted data archive are:
...
variable/column names were labelled with descriptive cleaner names.

Results were output as an independent tidy data set at ./merged_data_tidy_version.txt
